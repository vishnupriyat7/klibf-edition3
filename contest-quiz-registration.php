                            ...
                            <div class="card-body" style="margin-top: -10%;">
                                <div class="tab-content mt-2">
                                    ...
                                    <div class="align-items-center text-center">
                                        ...
                                        <!-- <p class="text-danger"><b>കോഴിക്കോട് മേഖലാതല ക്വിസ് രജിസ്‌ട്രേഷൻ 30.11.2024 12.00pm വരെ ദീർഘിപ്പിച്ചിരിക്കുന്നു.</b></p>
                                        <p class="text-danger"><b>എറണാകുളം മേഖലാതല ക്വിസ് രജിസ്‌ട്രേഷൻ 03.12.2024 വരെ ദീർഘിപ്പിച്ചിരിക്കുന്നു.</b></p> -->
                                        <!-- <p class="text-danger"><b>കോട്ടയം മേഖലാതല ക്വിസ് രജിസ്‌ട്രേഷൻ 05.12.2024 വരെ ദീർഘിപ്പിച്ചിരിക്കുന്നു.</b></p> -->
                                        <p class="text-danger"><b>തിരുവനന്തപുരം മേഖലാതല ക്വിസ് രജിസ്‌ട്രേഷൻ 06.01.2025 വരെ ദീർഘിപ്പിച്ചിരിക്കുന്നു.</b></p>
                                    ...
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-sm-12 mt-4">
                                        ...
                                        <ul class="custom-bullet">
                                            ...
                                            <li>
                                                <p>
                                                    പൊതുജനങ്ങൾക്കായി 2025 ജനുവരി 11-ന് നിയമസഭാ മന്ദിരത്തിൽ വച്ച് എഴുത്തുപരീക്ഷ നടത്തുന്നതും ആയതിൽ ആദ്യ 6 സ്ഥാനങ്ങളിൽ എത്തുന്ന ടീമുകൾക്കായി ഫൈനൽ മത്സരം നടത്തുന്നതുമാണ് . മത്സരാർത്ഥികൾ അന്നേ ദിവസം രാവിലെ 10 മണിക്ക് മുൻപ് നിയമസഭാ മന്ദിരത്തിൽ റിപ്പോർട്ട് ചെയ്യേണ്ടതാണ്. (രജിസ്‌ട്രേഷൻ 09.01.2025 വരെ)</p>
                                            </li>
                                            <li>
                                                <p>
                                                    ...
                                                    <tbody>
                                                        <tr style="font-size: 18px;">
                                                            ...
                                                            <td data-label="ഓൺലൈൻ രജിസ്ട്രേഷനുള്ള അവസാന തീയതി">22.11.2024
                                                                <p class="text-danger fw-bold">Extended Date<br>26.11.2024</p>
                                                            </td>
                                                        ...
                                                        <tr style="font-size: 18px;">
                                                            ...
                                                            <td data-label="ഓൺലൈൻ രജിസ്ട്രേഷനുള്ള അവസാന തീയതി">03.12.2024</td>
                                                        ...
                                                        <tr style="font-size: 18px;">
                                                            ...
                                                            <td data-label="ഓൺലൈൻ രജിസ്ട്രേഷനുള്ള അവസാന തീയതി">30.11.2024
                                                            <p class="text-danger fw-bold">Extended Date<br>05.12.2024</p>
                                                            </td>
                                                            <td data-label="പ്രാഥമിക മത്സര തീയതി">7.12.2024</td>
                                                            <td data-label="വേദി">സെന്റ് ജോസഫ്‌സ് പബ്ലിക് സ്‌കൂൾ, കുന്നുംഭാഗം, കാഞ്ഞിരപ്പള്ളി കോട്ടയം</td>
                                                        </tr>
                                                        <tr style="font-size: 18px;">
                                                            ...
                                                            <td data-label="ഓൺലൈൻ രജിസ്ട്രേഷനുള്ള അവസാന തീയതി">31.12.2024
                                                            <p class="text-danger fw-bold">Extended Date<br>06.01.2025</p></td>
