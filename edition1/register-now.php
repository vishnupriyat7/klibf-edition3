            ...
            <div class="col-12">
                ...
                <div class="contact-box text-center">
                    ...
                    if (isset($_POST['save'])) {
                        ...
                        // $ext_array = array("png", "jpeg", "jpg", "pdf", "odt");
                        ...
                        <div class="row bg-grey">
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <input class="form-control text-right" value="8000" id="amt3x2" disabled>
                                    </div>
                                    <div class="col-3">
...
<script type="text/javascript">
    ...
    document.getElementById("preview_btn").addEventListener("click", function(event) {
        ...
        document.getElementById("3x3amt_lab").innerHTML = "₹." + $("#totamt").val() + "/-";
