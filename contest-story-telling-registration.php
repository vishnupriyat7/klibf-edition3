        ...
        <section class="breadcrumbs">
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <h2>Storry Telling Registration</h2>
                    <ol>
                    ...
                    <div class="col-xxl-12 col-xl-12 col-md-12 col-lg-12 col-sm-12">
                        <div class="card mt-6">
                            ...
                            <div class="text-center">
                                <img class="mx-auto d-block img-fluid" src="./assets/img/contests/Katha_Web.jpg" style="width: 100%;">
                            </div>
                            ...
                            <div class="card-body" style="margin-top: -10%;">
                                <div class="tab-content malayalam-text">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <!-- <a href="https://docs.google.com/forms/d/e/1FAIpQLSeNApHxzyo9OP8y3582bdaLhGQ1Uc0u5YlrTqCuGrQQOdj-pw/viewform" target="_blank" title="More Details"><button class="btn btn-success horizontal-shake" style="font-size: 16px;">Apply</button></a>
                                        &emsp; -->
                                    ...
                                    <div class="modal" id="result">
                                        <div class="modal-dialog modal-dialog-centered modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="embed-responsive embed-responsive-16by9">
                                                        <iframe src="assets/img/contests/pdf/story-telling-results.pdf" class="embed-responsive-item" width="100%" height="700px"></iframe>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <ul class="custom-bullet">
                                        ...
                                        <li>
                                                <p class="text-danger"><b>എൻട്രികൾ ലഭിക്കുന്നതിനുള്ള അവസാന തീയതി 15-12-2024 വരെ ദീർഘിപ്പിച്ചിരിക്കുന്നു.</b></p>
                                            </li>
