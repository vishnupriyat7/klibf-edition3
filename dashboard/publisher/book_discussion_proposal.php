                ...
                <div class="col-xxl-9">
                    <div class="card mt-xxl-n5">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Book Discusion Proposal</h5>
                        </div>
                        <?php
                        $status = "OK";
                        $msg = "";
                        if ($user_id) {
                            ...
                            $disc_book_cover = $bkdscndetls['book_cover'];
                        ...
                        if (isset($_POST['disc_save'])) {
                            ...
                            if (!empty($_FILES["disc_book_cover"]["name"])) {
                                ...
                                if (in_array($fileType, $allowTypes)) {
                                    ...
                                    $newFileName = $disc_sub . '-' . uniqid() . '.' . $fileType;
                            ...
                            if ($status == "NOTOK") {
                                ...
                                if ($bkdscndetls) {
                                    if (!$newFileName && $disc_book_cover) {
                                        ...
                                        $query1 = "UPDATE evnt_propsl_bkdscn SET subject = '$disc_sub', book_name = '$disc_book', moderator = '$modrtr', modrtr_cntct = '$modrtr_cntct', participant1 = '$prtcpnt1', part1_cntct = '$prtcpnt1_cntct',  participant2 = '$prtcpnt2', part2_cntct = '$prtcpnt2_cntct', participant3 = '$prtcpnt3', part3_cntct = '$prtcpnt3_cntct', participant4 = '$prtcpnt4', part4_cntct = '$prtcpnt4_cntct', cntct_name = '$cntct_name', cntct_mail = '$cntct_mail', cntct_phno = '$cntct_phno', remarks = '$disc_remark', book_cover = '$newFileName', updated_at = '$date' WHERE id = $bkdscn_id";
                                    }
                                } else {
                                    $query1 = "INSERT INTO evnt_propsl_bkdscn (user_id, subject, book_name, moderator, participant1, participant2, participant3, participant4, cntct_name, cntct_phno, cntct_mail, updated_at, remarks, status, modrtr_cntct, part1_cntct, part2_cntct, part3_cntct, part4_cntct, book_cover) VALUES ('$user_id', '$disc_sub', '$disc_book', '$modrtr', '$prtcpnt1', '$prtcpnt2', '$prtcpnt3', '$prtcpnt4', '$cntct_name', '$cntct_phno', '$cntct_mail', '$date', '$disc_remark', 'E', '$modrtr_cntct', '$prtcpnt1_cntct', '$prtcpnt2_cntct', '$prtcpnt3_cntct', '$prtcpnt4_cntct', '$newFileName')";
                                }
                                        ...
                                        <div class="row bg-grey">
                                            <div class="form-group col-6">
                                                ...
                                                <input type="text" class="form-control" name="disc_sub"
                                                    placeholder="Subject" id="disc_sub" value="<?= $disc_sub; ?>"
                                                    <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                Name of Book
                                                <input type="text" class="form-control" name="disc_book" id="disc_book"
                                                    placeholder="Name of Book" value="<?= $disc_book; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Moderator
                                                <input type="text" class="form-control" name="modrtr" id="modrtr"
                                                    placeholder="Moderator" value="<?= $modrtr; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Contact No.
                                                <input type="text" class="form-control" name="modrtr_cntct"
                                                    id="modrtr_cntct" placeholder="Moderator Contact No."
                                                    value="<?= $modrtr_cntct; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Particiapant 1
                                                <input type="text" class="form-control" name="prtcpnt1" id="prtcpnt1"
                                                    placeholder="Particiapant 1" value="<?= $prtcpnt1; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Contact No.
                                                <input type="text" class="form-control" name="prtcpnt1_cntct"
                                                    id="prtcpnt1_cntct" placeholder="Particiapant 1 Contact No."
                                                    value="<?= $prtcpnt1_cntct; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Particiapant 2
                                                <input type="text" class="form-control" name="prtcpnt2" id="prtcpnt2"
                                                    placeholder="Particiapant 2" value="<?= $prtcpnt2; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Contact No.
                                                <input type="text" class="form-control" name="prtcpnt2_cntct"
                                                    id="prtcpnt2_cntct" placeholder="Particiapant 2 Contact No."
                                                    value="<?= $prtcpnt2_cntct; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Particiapant 3
                                                <input type="text" class="form-control" name="prtcpnt3" id="prtcpnt3"
                                                    placeholder="Particiapant 3" value="<?= $prtcpnt3; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Contact No.
                                                <input type="text" class="form-control" name="prtcpnt3_cntct"
                                                    id="prtcpnt3_cntct" placeholder="Particiapant 3 Contact No."
                                                    value="<?= $prtcpnt3_cntct; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Particiapant 4
                                                <input type="text" class="form-control" name="prtcpnt4" id="prtcpnt4"
                                                    placeholder="Particiapant 4" value="<?= $prtcpnt4; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                <br>
                                                Contact No.
                                                <input type="text" class="form-control" name="prtcpnt4_cntct"
                                                    id="prtcpnt4_cntct" placeholder="Particiapant 4 Contact No."
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <select class="form-control form-group" name="evnt_day1"
                                                    ...
                                                    <?php foreach ($event_days as $event_day) {
                                                        ...
                                                        ?>
                                                        <option value="<?= $event_day[0] ?>" <?= $evntDay1Select; ?>>
                                                            <?= $event_day[1]; ?> - <?= $event_day[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="form-group col-6">
                                                ...
                                                <select class="form-control form-group" name="time_slot1"
                                                    ...
                                                    <?php foreach ($event_slots as $event_slot) {
                                                        ...
                                                        ?>
                                                        <option value="<?= $event_slot[0] ?>" <?= $evntTme1Select; ?>>
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <select class="form-control form-group" name="evnt_day2"
                                                    ...
                                                    <?php foreach ($event_days as $event_day) {
                                                        ...
                                                        ?>
                                                        <option value="<?= $event_day[0] ?>" <?= $evntDay2Select; ?>>
                                                            <?= $event_day[1]; ?> - <?= $event_day[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <select class="form-control form-group" name="time_slot2"
                                                    ...
                                                    <?php foreach ($event_slots as $event_slot) {
                                                        ...
                                                        ?>
                                                        <option value="<?= $event_slot[0] ?>" <?= $evntTme2Select; ?>>
                                                            <?= $event_slot[1]; ?> - <?= $event_slot[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <select class="form-control form-group" name="evnt_day3"
                                                    ...
                                                    <?php foreach ($event_days as $event_day) {
                                                        ...
                                                        ?>
                                                        <option value="<?= $event_day[0] ?>" <?= $evntDay3Select; ?>>
                                                            <?= $event_day[1]; ?> - <?= $event_day[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <select class="form-control form-group" name="time_slot3"
                                                    ...
                                                    <?php foreach ($event_slots as $event_slot) {
                                                        ...
                                                        ?>
                                                        <option value="<?= $event_slot[0] ?>" <?= $evntTme3Select; ?>>
                                                            <?= $event_slot[1]; ?> - <?= $event_slot[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input type="file" class="form-control" name="disc_book_cover"
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                Contact Person Name
                                                <input type="text" class="form-control" name="cntct_name"
                                                    id="cntct_name" placeholder="Contact Person Name"
                                                    value="<?= $cntct_name; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                </br>
                                                Contact Phone No.
                                                <input type="text" class="form-control" name="cntct_phno"
                                                    id="cntct_phno" placeholder="Contact Phone No."
                                                    value="<?= $cntct_phno; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                </br>
                                                Contact Email Id.
                                                <input type="email" class="form-control" name="cntct_mail"
                                                    id="cntct_mail" placeholder="Contact Email Id."
                                                    value="<?= $cntct_mail; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="form-group col-6">
                                                </br>
                                                Remarks
                                                <input type="text" class="form-control" name="disc_remark"
                                                    id="disc_remark" placeholder="Remarks" value="<?= $disc_remark; ?>"
                                                    <?= $edit; ?>>
                                            </div>
                                        </div><br>
                                        <div class="col-lg-12">
