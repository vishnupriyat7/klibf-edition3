            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Event Proposal</h4>
                    ...
                    <div class="col-xxl-9">
                        <div class="card mt-xxl-n5">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Book Release Proposal</h5>
                            </div>
                            <?php
                            $status = "OK";
                            $msg = "";
                            if ($user_id) {
                                ...
                                $book_cover = $bkrlsdetls['book_cover'];
                            ...
                            if (isset($_POST['bkrls_save'])) {
                                ...
                                if (!empty($_FILES["book_cover"]["name"])) {
                                    ...
                                    if (in_array($fileType, $allowTypes)) {
                                        $targetDir = "uploads/book_release_img/";
                                        $newFileName = $book_title . '-' . uniqid() . '.' . $fileType;
                                ...
                                if ($status == "NOTOK") {
                                    ...
                                    if ($bkrlsdetls) {
                                        if (!$newFileName && $book_cover) {
                                            ...
                                            $query = "UPDATE event_propsl_bkrls SET book_title = '$book_title', author = '$author',book_genere = '$book_genere', brf_description = '$brief_descrptn', released_by = '$release_by', relcd_by_cntct = '$releas_by_cntct', recived_by = '$recvd_by', recvd_by_contact = '$recvd_by_cntct', guest1 = '$guest1', guest1_contct = '$guest1_cntct', guest2 = '$guest2', guest2_contct = '$guest2_cntct', guest3 = '$guest3', guest3_contct = '$guest3_cntct', contact_persn_name = '$bkrls_cntct_persn_name', contact_persn_email = '$bkrls_cntct_persn_email', contact_persn_mobile = '$bkrls_cntct_persn_mobile', remarks = '$remark', book_cover = '$newFileName', updated_at = '$date' WHERE id = $bkrls_id";
                                        }
                                    } else {
                                        ...
                                        <div class="row bg-grey">
                                            <div class="col-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="book_title"
                                                    id="book_title" placeholder="Book Title" value="<?= $book_title; ?>"
                                                    <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                ...
                                                <select class="form-control form-group" name="book_genere"
                                                    ...
                                                    <?php foreach ($book_generes as $genere) {
                                                        ...
                                                        <option value="<?= $genere[0] ?>" <?= $genere_selected ?>>
                                                            <?= $genere[1]; ?>     <?= $genere[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <textarea class="form-control" name="brief_descrptn" id="brief_descrptn"
                                                    placeholder="Description" value="<?= $brief_descrptn; ?>" <?= $edit; ?>><?= $brief_descrptn; ?></textarea>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Author</label>
                                                <input type="text" class="form-control" name="author" id="author"
                                                    placeholder="Author" value="<?= $author; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Releasing by</label>
                                                <input type="text" class="form-control" name="release_by"
                                                    id="release_by" placeholder="Releasing by"
                                                    value="<?= $release_by; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Contact</label>
                                                <input type="text" class="form-control" name="releas_by_cntct"
                                                    id="releas_by_cntct" placeholder="Releasing by Contact"
                                                    value="<?= $releas_by_cntct; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Receiving by</label>
                                                <input type="text" class="form-control" name="recvd_by" id="recvd_by"
                                                    placeholder="Received by" value="<?= $recvd_by; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Contact</label>
                                                <input type="text" class="form-control" name="recvd_by_cntct"
                                                    id="recvd_by_cntct" placeholder="Receiving by Contact"
                                                    value="<?= $recvd_by_cntct; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Guest 1</label>
                                                <input type="text" class="form-control" name="guest1" id="guest1"
                                                    placeholder="Guest 1" value="<?= $guest1; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Contact</label>
                                                <input type="text" class="form-control" name="guest1_cntct"
                                                    id="guest1_cntct" placeholder="Guest1 Contact"
                                                    value="<?= $guest1_cntct; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Guest 2</label>
                                                <input type="text" class="form-control" name="guest2" id="guest2"
                                                    placeholder="Guest 2" value="<?= $guest2; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label> Contact</label>
                                                <input type="text" class="form-control" name="guest2_cntct"
                                                    id="guest2_cntct" placeholder="Guest2 Contact"
                                                    value="<?= $guest2_cntct; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Guest 3</label>
                                                <input type="text" class="form-control" name="guest3" id="guest3"
                                                    placeholder="Guest 3" value="<?= $guest3; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label> Contact</label>
                                                <input type="text" class="form-control" name="guest3_cntct"
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <select class="form-control form-group" name="evnt_day1" id="evnt_day1"
                                                    ...
                                                    foreach ($event_days as $days) {
                                                        ...
                                                        ?>
                                                        <option value="<?= $days[0] ?>" <?= $evnt_day1_selected ?>>
                                                            <?= $days[1]; ?> - <?= $days[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <select class="form-control form-group" name="time_slot1"
                                                    id="time_slot1" style="height:35px;">
                                                    <option value="0" <?= $select0; ?>>Select Proposed Event Time
                                                    </option>
                                                    <?php
                                                    foreach ($event_slots as $event_slot) {
                                                        $time_slot1_selected = $event_slot[0] == $time_slot1 ? "selected" : "";
                                                        ?>
                                                        <option value="<?= $event_slot[0] ?>" <?= $time_slot1_selected ?>>
                                                            <?= $event_slot[1]; ?> - <?= $event_slot[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="col-6 form-group">
                                                ...
                                                <select class="form-control form-group" name="evnt_day2" id="evnt_day2"
                                                    ...
                                                    foreach ($event_days as $days) {
                                                        ...
                                                        ?>
                                                        <option value="<?= $days[0] ?>" <?= $evnt_day2_selected ?>>
                                                            <?= $days[1]; ?> - <?= $days[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <select class="form-control form-group" name="time_slot2"
                                                    id="time_slot2" style="height:35px;">
                                                    <option value="0" <?= $select0; ?>>Select Proposed Event Time
                                                    </option>
                                                    <?php
                                                    foreach ($event_slots as $event_slot) {
                                                        $time_slot2_selected = $event_slot[0] == $time_slot2 ? "selected" : "";
                                                        ?>
                                                        <option value="<?= $event_slot[0] ?>" <?= $time_slot2_selected ?>>
                                                            <?= $event_slot[1]; ?> - <?= $event_slot[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <select class="form-control form-group" name="evnt_day3" id="evnt_day3"
                                                    ...
                                                    foreach ($event_days as $days) {
                                                        ...
                                                        ?>
                                                        <option value="<?= $days[0] ?>" <?= $evnt_day3_selected ?>>
                                                            <?= $days[1]; ?> - <?= $days[2]; ?>
                                                        </option>
                                                    <?php } ?>
                                                </select>
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <input type="text" class="form-control" name="cntct_persn_name"
                                                    id="cntct_persn_name" placeholder="Contact Person Name"
                                                    value="<?= $bkrls_cntct_persn_name; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Contact Person Mobile</label>
                                                <input type="text" class="form-control" name="cntct_persn_mobile"
                                                    id="cntct_persn_mobile" placeholder="Contact Person Mobile" min="0"
                                                    value="<?= $bkrls_cntct_persn_mobile; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Contact Person Email</label>
                                                <input type="email" class="form-control" name="cntct_persn_email"
                                                    id="cntct_persn_email" placeholder="Contact Person Email" min="0"
                                                    value="<?= $bkrls_cntct_persn_email; ?>" <?= $edit; ?>>
                                            </div>
                                            <div class="col-6 form-group">
                                                <br>
                                                <label>Remarks / Other information</label>
                                                <textarea class="form-control" name="remark" id="remark"
                                                    placeholder="Remarks / Other information" value="<?= $remark; ?>"
