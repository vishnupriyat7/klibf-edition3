                                    ...
                                    <div class="row bg-grey">
                                        <div class="col-6 form-group">
                                            ...
                                            <input type="text" class="form-control" name="book_title" id="book_title"
                                                placeholder="Book Title" value="<?= $book_title; ?>" <?= $edit; ?>>
                                        </div>
                                        <div class="col-6 form-group">
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <input type="text" class="form-control" name="release_by" id="release_by"
                                                placeholder="Releasing by" value="<?= $release_by; ?>" <?= $edit; ?>>
                                        </div>
                                        <div class="col-6 form-group">
                                            <br>
                                            <label>Contact</label>
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="form-control form-group" name="time_slot1" id="time_slot1"
                                                style="height:35px;">
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="form-control form-group" name="time_slot2" id="time_slot2"
                                                style="height:35px;">
                                                <option value="0" <?= $select0; ?>>Select Proposed Event Time</option>
                                                <?php
                                                foreach ($event_slots as $event_slot) {
                                        ...
                                        <div class="col-6 form-group">
                                            ...
                                            <select class="form-control form-group" name="time_slot3" id="time_slot3"
                                                style="height:35px;">
                                                <option value="0" <?= $select0; ?>>Select Proposed Event Time</option>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="file" class="form-control" name="book_cover" id="book_cover"
                                                placeholder="*Upload Bookcover" <?= $hide; ?> <?= $edit; ?>>
