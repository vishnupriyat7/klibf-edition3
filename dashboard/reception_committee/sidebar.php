    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?= $base_url ?>/dashboard/reception_committee/registration_report.php" role="button" aria-controls="sidebarLanding">
                        <i class="ri-file-list-3-line"></i> <span data-key="t-landing">Queue Register Report</span>
                    </a>
                </li>
            </ul>
        </div>
