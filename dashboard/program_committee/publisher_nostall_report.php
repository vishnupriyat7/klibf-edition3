                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Profile Not Created Report</h5>
                        </div>
                        <div class="card-body overflow-auto">
                            ...
                            <table id="example" class="table table-bordered dt-responsive nowrap table-striped" style="font-style:normal; font-size: 12px;">
                                ...
                                <tbody>
                                    <?php
                                    $query = "SELECT a.* FROM users a LEFT JOIN users_profile b ON a.id = b.user_id LEFT JOIN stall_booking c ON a.id = c.user_id WHERE c.user_id IS NULL and b.user_id IS NOT NULL and a.user_type='P'";
