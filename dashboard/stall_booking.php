                                ...
                                <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php if ($stall_status != 'S') { ?>
                                            <div class="col-md-12">
                                                <br>
                                                <input type="checkbox" name="terms" required="required" class="text-justify" id="terms">&emsp;I/We, <?= $user_stall['org_name'] ?>, hereby agree to abide by the <a href="stall_rules_regulation.php" target="_blank"> &nbsp;Terms & Conditions</a> of the Kerala Legislature International Book Festival 2023 2nd Edition given in the Terms and Conditions and as decided by the Kerala Legislature Secretariat from time to time.
                                                <br><br>
