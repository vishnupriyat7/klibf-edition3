            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" role="button" aria-controls="sidebarLanding"
                        href="<?= $base_url ?>/dashboard/cultural_committee/rules_regulation.php" class="nav-link" data-key="t-one-page">
                ...
                <li class="nav-item">
                    ...
                    <div class="menu-dropdown collapse" id="sidebarX">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="<?= $base_url ?>/dashboard/cultural_committee/book_release_report.php"
                                    class="nav-link" data-key="t-nft-landing">Book Release Report </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= $base_url ?>/dashboard/cultural_committee/book_discussion_report.php"
                                    class="nav-link" data-key="t-nft-landing">Book Discussion Report </a>
                            </li>
                        </ul>
                    </div>
                </li>
