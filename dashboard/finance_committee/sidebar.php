            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" role="button" aria-controls="sidebarLanding"
                        href="<?= $base_url ?>/dashboard/finance_committee/stall_payment_report.php" class="nav-link" data-key="t-one-page">
                        <i class="ri-file-list-3-line"></i> <span data-key="t-landing">Stall Payment Verify</span>
                    </a>
                </li>
