...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <a href="index.php" class="logo logo-dark">
            ...
            <span class="logo-lg">
                <img src="../assets/img/Logo_KLIBF03_BG.png" alt="" height="90">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="index.php" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="../assets/img/Logo_KLIBF03_BG.png" alt="" width="100%" height="90">
            </span>
        </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="menu-dropdown collapse" id="sidebarT" style="">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="testimonylist.php" class="nav-link" data-key="t-nft-landing"> All Testimonies
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="menu-dropdown collapse" id="sidebarK" style="">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="section-title.php" class="nav-link" data-key="t-nft-landing"> Section Titles
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="updatecontact.php" class="nav-link" data-key="t-nft-landing"> Update Contact
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="menu-dropdown collapse" id="sidebarX" style="">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="quiz_reg_report.php" class="nav-link" data-key="t-nft-landing">Quiz Contest
                                    Report </a>
                            </li>
                            <li class="nav-item">
                                <a href="queue_report.php" class="nav-link" data-key="t-nft-landing">Virtual Queue
                                    Report </a>
                            </li>
                        </ul>
                    </div>
