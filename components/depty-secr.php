<!-- ======= Deputy Speaker & Secretary Section ======= -->
<section id="dysecmsg" class="dysecmsg">
    <div class="container">
        <div class="row no-gutters">
            ...
            sparkle. Let this Book Festival help spread the light of knowledge. Let us pledge to make this world a
            ...
            cherished by future generations. -->
                    </p> <a href="dyspeaker-message-inner.php">Read More...</a>
                </div>
            </div>
            ...
            <div class="col-md-6 row" data-aos="fade-right">
                <div class="content">
                    ...
                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 p-2">
                        <div class="spkr-thumb text-center wow fadeInLeft slow">
                            <iframe width="500" height="300" src="https://www.youtube.com/embed/AKb8NCL5gMo" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" frameborder="0" allowfullscreen></iframe>
                            </iframe>
                            <!-- <p class="text-lg text-center mt-3">Shri. A N Shamseer, Hon’ble Speaker, Kerala Legislative Assembly</p> -->
                        </div>
                    </div>
            ...
            knowledge. I am sure the Kerala Legislature International Book Festival will be a significant milestone
            cherished by future generations. -->
                    </p> <a href="secretary-message-inner.php">Read More...</a>
                </div>
            </div>
