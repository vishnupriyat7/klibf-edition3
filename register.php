            ...
            if ($password === $confirm_password) {
                ...
                if ($result) {
                    ...
                    try {
                        ...
                        $mail->Username   = 'vishnupriya.t7@gmail.com';                     //SMTP username
                        $mail->Password   = 'akdamxborrvlmqjv';                               //SMTP password
                        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                        $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                        //Recipients
                        $mail->setFrom('vishnupriya.t7@gmail.com');
                ...
                <div class="main-mockup">
                    ...
                    <div class="content-wthree">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="text" class="contactno" name="contactno" placeholder="Enter Your Contact No" value="<?php if (isset($_POST['submit'])) { echo $contactno; } ?>" required>
