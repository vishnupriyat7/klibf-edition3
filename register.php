        ...
        if ($password === $confirm_password) {
            ...
            if ($result) {
                ...
                try {
                    ...
                    $mail->Body    = 'You have successfully registered in KLIBF Edition III .<br>Here is the login credentials.<br>Usename: ' . $email . '<br>Password:' . $_POST['password'] . '</b>';
