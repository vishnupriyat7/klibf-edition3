        ...
        <div class="container">
          <div class="table-responsive">
            <table id="example" class="table table-light table-bordered table-hover">
              ...
              <tbody id="table-body">
                <?php
                $query = "SELECT up.id, up.user_id, up.fascia, up.logo, ch.user_id, ch.status, pc.* FROM users_profile up JOIN publisher_catalogue pc up.user_id = pc.user_id JOIN challan ch ON up.user_id = ch.user_id WHERE ch.status = 'A' ORDER BY up.fascia ASC";
                ...
                $img = "dashboard/publisher/uploads/catalogue" . $publshr['img'];
                ?>
                  <tr>
                    <td>
                      <?= ++$counter; ?>
